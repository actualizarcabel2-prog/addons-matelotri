...
def main_menu():
    ...
    items = [
        ...
        ("📜 Historia", "catalog/movie/matelotri-historia.json", "peliculas"),
        ("🎵 Música", "catalog/movie/matelotri-musica.json", "musica"),
        ("🔮 Misterio", "catalog/movie/matelotri-misterio.json", "peliculas"),
        ("🤠 Western", "catalog/movie/matelotri-western.json", "peliculas"),
        ("⚽ Deportes", "catalog/movie/matelotri-deportes.json", "peliculas"),
        # --- SERIES ---
        ...
        ("💪 Series Acción", "catalog/series/matelotri-series-accion.json", "series"),
        ("😂 Series Comedia", "catalog/series/matelotri-series-comedia.json", "series"),
        ("👶 Infantil", "catalog/series/matelotri-series-kids.json", "dibujos"),
        ("🔮 Series Misterio", "catalog/series/matelotri-series-misterio.json", "series"),
        ("📷 Reality", "catalog/series/matelotri-series-reality.json", "series"),
        ("🚀 Sci-Fi Series", "catalog/series/matelotri-series-scifi.json", "series"),
        ("💔 Telenovela", "catalog/series/matelotri-series-soap.json", "series"),
        ("🎤 Talk Show", "catalog/series/matelotri-series-talk.json", "series"),
        ("⚔️ Guerra y Política", "catalog/series/matelotri-series-guerra.json", "series"),
        ("🤠 Western Series", "catalog/series/matelotri-series-western.json", "series"),
        ("📰 Noticias", "catalog/series/matelotri-series-noticias.json", "series"),
